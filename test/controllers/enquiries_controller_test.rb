...
class EnquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post enquiries_url, params: { enquiry: { agent_id: @enquiry.agent_id, email: @enquiry.email, message: @enquiry.message, name: @enquiry.name, phone: @enquiry.phone, postcode: @enquiry.postcode, property_id: @enquiry.property_id } }
    end
  ...
  test "should update enquiry" do
    patch enquiry_url(@enquiry), params: { enquiry: { agent_id: @enquiry.agent_id, email: @enquiry.email, message: @enquiry.message, name: @enquiry.name, phone: @enquiry.phone, postcode: @enquiry.postcode, property_id: @enquiry.property_id } }
